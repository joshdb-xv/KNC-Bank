    ...
    <div className="min-h-screen relative overflow-hidden bg-white">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6">
        ...
        <p className="text-xl text-center font-medium max-w-xl mb-8 text-black tracking-wide leading-relaxed">
          Built for people who like control without the confusion. Deposit,
          withdraw, track — your money, your rules.
        </p>
        <div className="flex space-x-4">
          <button
            onClick={handleStart}
            className="px-12 py-3 rounded-xl text-xl font-semibold bg-primary text-orange-50 hover:bg-primary-light hover:scale-105 transition-all duration-200 cursor-pointer"
          >
            Get Started
          </button>
        </div>
